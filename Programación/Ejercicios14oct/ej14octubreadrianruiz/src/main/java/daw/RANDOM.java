...
public class RANDOM {
    public static void main(String[] args) {
        ...
        do {
            ...
            if (J1 == 1) {System.out.println("J1, vas a pares"); System.out.println("J2, vas a impares");}  
            if (J1 == 2) {System.out.println("J1, vas a impares"); System.out.println("J2, vas a pares");} 
        ...
        System.out.println("El jugador 2 ha sacado el numero " + numeroJ2);
          if (suma % 2 == 0) { System.out.println("J1 gana");    
          } else {System.out.println("J2 gana");} 
